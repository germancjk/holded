...
var routes = [{
  ...
  name: 'board',
  component: function component() {
    return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ../views/Board.vue */ "./resources/js/views/Board.vue"));
  }
}, {
  path: '/logout',
  name: 'logout',
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    loadCategories: function loadCategories(state) {
      ...
      axios.get('api/category').then(function (response) {
        ...
        state.categories = [].concat(data);
      });
    },
    loadStores: function loadStores(state) {
      var token = localStorage.getItem('jwt');
      axios.defaults.headers.common['Content-Type'] = 'application/json';
      axios.defaults.headers.common['Authorization'] = 'Bearer ' + token;
  ...
  actions: {
    ...
    getStores: function getStores(_ref2) {
